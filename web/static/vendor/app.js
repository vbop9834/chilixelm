...
var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$btn = F4(
	function (btnOption, btnModifiers, attributes, htmlList) {
		var getButtonModifierClass = function (btnModifier) {
			var _p0 = btnModifier;
			switch (_p0.ctor) {
				case 'BtnLarge':
					return 'btn-lg';
		...
		var classes = function () {
			var buttonModifierClasses = _elm_lang$core$String$concat(
				A2(
					...
					A2(_elm_lang$core$List$map, getButtonModifierClass, btnModifiers)));
			return A2(
		...
		var attributes = A2(
			...
			attributes);
		return A2(_elm_lang$html$Html$button, attributes, htmlList);
	});
...
var _JeremyBellows$elm_bootstrapify$Bootstrap_Forms$formGroup = F2(
	function (formGroupOption, htmlList) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class(formGroupClass)
				]),
			htmlList);
	});
var _JeremyBellows$elm_bootstrapify$Bootstrap_Forms$form = F3(
	function (formAlignmentOption, attributes, htmlList) {
		...
		var attributes = A2(
			_elm_lang$core$List_ops['::'],
			_elm_lang$html$Html_Attributes$class(formAlignmentClass),
			attributes);
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(message.user)
							])),
...
var _user$project$App$CraftUsername = function (a) {
	return {ctor: 'CraftUsername', _0: a};
};
var _user$project$App$HandleSendError = function (a) {
	return {ctor: 'HandleSendError', _0: a};
};
var _user$project$App$ShowLeftMessage = {ctor: 'ShowLeftMessage'};
var _user$project$App$ShowJoinedMessage = {ctor: 'ShowJoinedMessage'};
...
var _user$project$App$CraftMessage = function (a) {
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$App$JoinChannel)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$App$LeaveChannel)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_JeremyBellows$elm_bootstrapify$Bootstrap_ListGroup$listGroup(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Events$onInput(_user$project$App$CraftUsername)
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Events$onInput(_user$project$App$CraftMessage)
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
		...
		switch (_p0.ctor) {
			...
			case 'JoinChannel':
				var channel = A2(
					...
					_elm_lang$core$Basics$always(_user$project$App$ShowLeftMessage),
					A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
						_elm_lang$core$Basics$always(_user$project$App$ShowJoinedMessage),
						A2(
...
var _user$project$App$SomethingNew = {ctor: 'SomethingNew'};
